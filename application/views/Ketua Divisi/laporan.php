                ...
                <tbody>
                  <?php
                    ...
                    <tr>
                      ...
                      <?php
                      if ($status1 == "1" && $status2 == "1" && $status == "0") {
                        ?>
                        <button class="btn btn-success btn-sm" title="Setuju" data-toggle="modal" data-target="#setuju" onclick="fetchSetuju(this)" data-id_proker="<?= $row->id_proker ?>" data-status="<?= $row->lpj_kadiv ?>"><i class="fas fa-check-circle"></i></button>
                        <button class="btn btn-danger btn-sm" title="Tolak" data-toggle="modal" data-target="#tolak" onclick="fetchTolak(this)" data-id_proker="<?= $row->id_proker ?>" data-status="<?= $row->lpj_kadiv ?>"><i class="fa fa-times-circle"></i></button>
                      <?php } else {
                      echo "No Action";
                      ?>
                    </td>
...
<div class="modal fade" id="setuju" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" action="<?= site_url('Kadiv/laporan') ?>" class="form-submit" method="post">
