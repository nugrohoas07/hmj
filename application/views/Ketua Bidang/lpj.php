          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="alert alert-primary">
                <h5>Upload Masukan Dan Saran Tiap Laporan Kegiatan Serta Kata Pengantar Pada Tombol Dibawah Ini<i class="icon fas fa-info float-right"></i></h5>
              </div>
                <div class="block mt-3 mb-4 text-left">
                  <a href="<?= site_url('Kabid/addLpj') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Upload File</a>
                </div>
              <?php
              } ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" action="<?php echo site_url('Kabid/lpj') ?>" method="post" enctype="multipart/form-data" class="form-submit">
