                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <?php if ($row->status == 3||$row->status == 5|| $row->status == 6) { ?>
                      ...
                      <td class="text-center">
                        ...
                        <?php } elseif ($row->status == 3 || $row->status == 4 || $row->status == 5 || $row->status == 6) { ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background-color: dodgerblue; color: whitesmoke;">
        <h5 class="modal-title">Beri Tanda Tangan</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span style="color: whitesmoke;" aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form role="form" action="<?php echo site_url('ketum/persetujuan') ?>" method="post" enctype="multipart/form-data" class="form-submit">
      ...
      <div class="modal-footer">
        <div class="form-group">
          <input type="hidden" name="id_dokumen" id="id_dokumen_setuju" required>
...
<div class="modal fade" id="tolak" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" action="<?php echo site_url('Ketum/persetujuan') ?>" method="post" enctype="multipart/form-data" class="formSubmit" data-btn="tolak">

          <div class="form-group">
            <label for="keterangan">Beri Keterangan Menolak</label>
            <input type="text" class="form-control" id="tolak_edit" name="keterangan" placeholder="Berikan Kritik/Saran" required>
          </div>
      </div>
      <div class="modal-footer">
        <input type="hidden" name="id_dokumen" id="id_dokumen_tolak" required>
