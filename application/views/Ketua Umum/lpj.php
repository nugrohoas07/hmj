        ...
        <div class="col-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <h5>Setelah Upload LPJ Maka Otomatis Menjadi Demisioner <i class="icon fas fa-info float-right"></i><br> Pastikan LPJ Semua Pengurus Sudah Di Upload</h5>
                </div>
                <div class="block mt-3 mb-4 text-left">
                  <a href="<?= site_url('ketum/addLpj') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Upload File</a>
                </div>
              <?php
              } ?>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td><?php
                          if ($idjab = $this->db->get_where('user', ['username' => $row->username])->row_array()) {
                            if ($jab = $this->db->get_where('role_jabatan', ['id_jabatan' => $idjab['jabatan']])->row_array()) {
                              if ($jab['jabatan'] == 'DPO') {
                                echo 'Ketua Umum';
                              } else {
                                echo $jab['jabatan'];
                      ...
                      <td class="text-center">
                          ...
                          ?>
                        <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#edit" onclick="fetchEdit(this)" data-id_lpj="<?= $row->id_lpj ?>" data-lpj="<?= $row->lpj ?>"><i class="fa fa-edit"></i></button>
                        <button class="btn btn-danger btn-xs" data-toggle="modal" data-target="#hapus" onclick="fetchHapus(this)" data-id_lpj="<?= $row->id_lpj ?>"><i class="fa fa-trash"></i></button>
                      <?php
                      }else{
                          echo 'No Action';
                      }
                  ...
                  <tr>
                      ...
                      <td><?= $prok->nama_proker
                          ?></td>
                      <td class="text-center">
                        <a href="<?= base_url('/upload/proker/') . $prok->lpj ?>" target="_blank" class="btn btn-primary">Lihat File</a>
                      </td>
                      <td class="text-center">
                        No Action
                      </td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="form-group">
          <input type="hidden" name="id_lpj" id="id_lpj_edit" data-validation="required">
...
<div class="modal fade" id="hapus" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form role="form" action="<?php echo site_url('ketum/lpj') ?>" method="post" enctype="multipart/form-data" class="form-submit">
          <input type="hidden" name="id_lpj" id="id_lpj_hapus" data-validation="required">
