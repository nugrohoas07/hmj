        ...
        <div class="col-12">
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Pengajuan Program Kerja</h3>
            </div>
            <div class="card-body">
              <div class="block mb-4 text-left">
                <a href="<?php echo site_url('Ketum/addProker'); ?>" class="btn btn-success" data-toggle="tooltip" title="Ajukan Proker"><i class="fa fa-plus"></i> Ajukan Proker</a>
              </div>
...
<div class="modal fade" id="edit" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" action="<?= site_url('ketum/proker'); ?>" class="form-submit" method="post" enctype="multipart/form-data">
              <div class="modal-body">
                  <div class="form-group">
                      <label for="namaproker">Program Kerja</label>
                      <input type="hidden" id="id_proker" name="id_proker">
                      <input type="text" class="form-control" id="proker" name="namaproker" placeholder="Nama Program Kerja" data-validation="required">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      ...
                      <input autocomplete="off" type="text" id="tglmulai" name="tglproker" class="form-control" placeholder="Tanggal Mulai" id="tglmulai" data-toggle="datetimepicker" data-target="#tglmulai" data-validation="required"/>
                  </div>
                  <div class="form-group">
                      <label>Tgl.Selesai</label>
                      <input autocomplete="off" type="text" id="tglakhir" name="tglselesai" class="form-control" placeholder="Tanggal Selesai" id="tglakhir" data-toggle="datetimepicker" data-target="#tglakhir" data-validation="required"/>
                  </div>
              </div>
...
<div class="modal fade" id="hapus" tabindex="-1" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form role="form" action="<?= site_url('Ketum/proker') ?>" class="form-submit" method="post">
      <div class="modal-footer">
