            ...
            <div class="card-body">
              ...
              ?>
                <div class="block mb-4 text-left">
                  <a href="<?= site_url('Sekretaris/addLpj') ?>" class="btn btn-success"><i class="fa fa-plus"></i> Upload File</a>
                </div>
              <?php
              } ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form role="form" action="<?php echo site_url('Sekretaris/lpj') ?>" method="post" enctype="multipart/form-data" class="form-submit">
